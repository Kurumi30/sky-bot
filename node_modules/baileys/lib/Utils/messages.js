...
/** Extracts the media content that can live inside an InteractiveMessage.Header */
...
/**
 * Accepts both the native flow shape ({ name, buttonParamsJson }) and the legacy
 * quick reply shape ({ buttonId, buttonText }), always returning a native flow button.
 * buttonParamsJson may be given as a plain object; cta_url gets merchant_url filled in,
 * without it WhatsApp Android renders the button disabled.
 */
